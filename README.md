...
Test suite: **1809 deterministic tests in 70 files, plus one automated Electron
...
├─ tests/              1809 deterministic tests + 1 routine Electron E2E; live provider E2E is opt-in

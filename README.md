...
Test suite: **1578 deterministic tests in 58 files, plus one automated Electron
...
├─ tests/              1578 deterministic tests + 1 routine Electron E2E; live provider E2E is opt-in
